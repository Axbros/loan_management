        ...
        <el-tabs type="border-card" class="demo-tabs">
            <el-tab-pane label="借款信息">
                <el-descriptions class="margin-top" title="本次風控審核" :column="4" border>
                    ...
                    <el-descriptions-item label="機審時間">
                        2025-03-01 12:00:00
                    </el-descriptions-item>
                ...
                <el-descriptions class="margin-top" title="本次借款信息" :column="4" border>
                    ...
                    <el-descriptions-item label="借款金額（元）">
                        3000.00
                    </el-descriptions-item>
                    <el-descriptions-item label="借款週期（天）">
                        5
                    </el-descriptions-item>
                    ...
                    <el-descriptions-item label="貸款類型">
                        首貸
                    </el-descriptions-item>
                    <el-descriptions-item label="借款利息（元）">
                        1500.00
                    </el-descriptions-item>
                    <el-descriptions-item label="加款金額（元）">
                        1500.00
                    </el-descriptions-item>
                    <el-descriptions-item label="放款時間">
                        2025-03-01 12:00:00
                    </el-descriptions-item>
                    <el-descriptions-item label="剩餘應還（元）">
                        --
                    </el-descriptions-item>
                    <el-descriptions-item label="應還時間">
                        2025-03-08 12:00:00
                    </el-descriptions-item>
                </el-descriptions>
            </el-tab-pane>
            <el-tab-pane label="用戶資料">
                <el-descriptions class="margin-top" title="註冊信息" :column="3" border>
                    <el-descriptions-item label="註冊手機號">
                        18002388777
                    </el-descriptions-item>
                    <el-descriptions-item label="註冊時間">
                        2025年3月18日 11:00:00
                    </el-descriptions-item>
                    <el-descriptions-item label="註冊客戶端">
                        H5
                    </el-descriptions-item>
                    <el-descriptions-item label="註冊渠道">
                        湖人-木木分期
                    </el-descriptions-item>

                    <el-descriptions-item label="註冊經緯度">
                        31.123456,121.123456
                    </el-descriptions-item>

                    <el-descriptions-item label="借款經緯度">
                        31.123456,121.123456
                    </el-descriptions-item>
                    <el-descriptions-item label="居住地">
                        四川省成都市邛崍市文君街道英倫半島
                    </el-descriptions-item>
                    <el-descriptions-item label="註冊所在地">
                        四川省成都市邛崍市文君街道英倫半島
                    </el-descriptions-item>

                    <el-descriptions-item label="借款所在地">
                        四川省成都市邛崍市文君街道英倫半島
                    </el-descriptions-item>
                </el-descriptions>
                ...
                <el-descriptions class="margin-top" title="實名信息" :column="3" border>
                    <el-descriptions-item label="真實姓名">
                        劉鑫
                    </el-descriptions-item>
                    ...
                    <el-descriptions-item label="運營商來源">
                        未授權
                    </el-descriptions-item>
                    <el-descriptions-item label="客戶來源">
                        http://eeee.one
                    </el-descriptions-item>
                ...
                <el-descriptions class="margin-top" title="銀行卡信息" :column="3" border>
                    ...
                    <el-descriptions-item label="銀行卡號">
                        6230943690000330652
                    </el-descriptions-item>
                    <el-descriptions-item label="銀行預留手機號">
                        18002388777
                    </el-descriptions-item>
                ...
                <el-descriptions class="margin-top" title="單位信息" :column="3" border>
                    ...
                    <el-descriptions-item label="單位電話">
                        028-12345678
                    </el-descriptions-item>
                    <el-descriptions-item label="單位地址">
                        四川省成都市武侯區辛康路56號
                    </el-descriptions-item>
            ...
            <el-tab-pane label="風控信息">
                <div class="title">
                    多頭借貸信息
                </div>

                <el-table :data="mutipleLoanData" align="center" header-align="center" stripe>
                    <el-table-column prop="time" label="時間範圍" />
                    <el-table-column prop="realname" label="實名認證" />
                    <el-table-column prop="bank" label="銀行卡認證" />
                    <el-table-column prop="mobile" label="運營商認證" />
                    <el-table-column prop="withdraw" label="提現分查詢" />
                    <el-table-column prop="register_platform" label="註冊平台" />
                </el-table>

                <div class="title">
                    共債信息匯總
                </div>
                <el-table :data="commomLoanData">
                    <el-table-column prop="mobile" label="手機號" />
                    <el-table-column prop="name" label="姓名" />
                    <el-table-column prop="total_request_number" label="申請筆數" />
                    <el-table-column prop="total_success_number" label="成功筆數" />
                    <el-table-column prop="total_return_number" label="還款筆數" />
                    <el-table-column prop="loan_platform_number" label="借款平台數" />
                    <el-table-column prop="loan_success_number" label="借款成功平台數" />
                    <el-table-column prop="loan_return_number" label="成功還款平台數" />
                    <el-table-column prop="loan_delay_number" label="逾期記錄平台數" />
                    <el-table-column prop="current_order_number" label="當前進行訂單數" />
                    <el-table-column prop="current_wait_check_number" label="當前待審核訂單數" />
                    <el-table-column prop="current_refuse_number" label="當前拒絕訂單數" />
                    <el-table-column prop="current_delay_number" label="當前逾期平台數" />
                    <el-table-column prop="recent_delay_platform_number" label="近月平台逾期數" />
                    <el-table-column prop="history_delay_platform_number" label="歷史逾期訂單數" />
                    <el-table-column prop="today_request_number" label="今日申請訂單數" />
                    <el-table-column prop="today_refuse_number" label="今日拒絕訂單數" />
                    <el-table-column prop="today_success_number" label="今日放款訂單數" />
                    <el-table-column prop="today_return_number" label="今日還款訂單數" />
                    <el-table-column prop="today_delay_number" label="今日逾期訂單數" />
                </el-table>
                <div class="title">
                    借款信息
                </div>
                <el-table :data="loanInfoData" >
                    <el-table-column prop="mobile" label="手機號" />
                    <el-table-column prop="name" label="姓名" />
                    <el-table-column prop="platform" label="平台名稱" />
                    <el-table-column prop="amount" label="借款金額" />

                    <el-table-column prop="time" label="借款時間" />
                ...
                <el-table :data="returnLoanInfo" >
                    ...
                    <el-table-column prop="time" label="借款時間" />
                    <el-table-column prop="deadline" label="到期時間" />

                    <el-table-column prop="return_amount" label="還款金額" />
                    <el-table-column prop="return_time" label="還款時間" />
                    <el-table-column prop="status" label="訂單狀態" >
                        <template #default="{ row }">
...
const commomLoanData=ref([{
    "mobile": "1800****777",
    "name": "劉鑫",
    "total_request_number": "0",
    "total_success_number": "0",
    "total_return_number": "0",
    "loan_platform_number": "0",
    "loan_success_number": "0",
    "loan_return_number": "0",
    "loan_delay_number": "0",
    "current_order_number": "0",
    "current_wait_check_number": "0",
    "current_refuse_number": "0",
    "current_delay_number": "0",
    "recent_delay_platform_number": "0",
    "history_delay_platform_number": "0",
    "today_request_number": "0",
    "today_refuse_number": "0",
    "today_success_number": "0",
    "today_return_number": "0",
    "today_delay_number": "0"
}])
...
const returnLoanInfo=ref([{
    "mobile": "1800****777",
    "name": "劉鑫",
    "platform": "螞蟻借呗",
    "amount": "3000.00",
    "time": "2025-03-01 12:00:00",
    "deadline": "2025-03-08 12:00:00",
    "return_amount": "3000.00",
    "return_time": "2025-04-01 12:00:00",
    "status": "0"
},{
    "mobile": "1800****777",
    "name": "劉魔王",
