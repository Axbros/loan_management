...
<el-card style="margin-top:20px">
    <el-table :data="tableData" style="width: 100%" fit>
        ...
        <el-table-column fixed="right" label="操作" min-width="120">
            <template #default>
                <el-button link type="primary" size="small" @click="centerDialogVisible = true">详情</el-button>
...
<el-dialog v-model="centerDialogVisible" title="用戶信息詳情" width="1200" center>
    <el-tabs type="border-card" class="demo-tabs">
        <el-tab-pane label="借款信息">
            <el-descriptions class="margin-top" title="本次風控審核" :column="4" border><template #extra>
                    <el-button type="primary">修改订单金额</el-button>
                </template>
                <el-descriptions-item label="審核結果">
                    <el-tag type="success">通過</el-tag>
                </el-descriptions-item>
                <el-descriptions-item label="機審分值">0</el-descriptions-item>
                <el-descriptions-item label="機審時間">2025-03-01
                    12:00:00</el-descriptions-item>
                <el-descriptions-item label="備注">T（1、4、7）逾期笔数过多</el-descriptions-item>

            </el-descriptions>

            <el-descriptions class="margin-top" title="本次借款信息" :column="4" border>
                <el-descriptions-item label="借款人姓名
">孔建雲</el-descriptions-item>
                <el-descriptions-item label="借款金額（元）">3000.00</el-descriptions-item>
                <el-descriptions-item label="借款週期（天）">5</el-descriptions-item>
                <el-descriptions-item label="申請時間">2025-03-01
                    12:00:00</el-descriptions-item>
                <el-descriptions-item label="貸款類型">首貸</el-descriptions-item>
                <el-descriptions-item label="借款利息（元）">1500.00</el-descriptions-item>
                <el-descriptions-item label="加款金額（元）">1500.00</el-descriptions-item>
                <el-descriptions-item label="放款時間">2025-03-01
                    12:00:00</el-descriptions-item>
                <el-descriptions-item label="剩餘應還（元）">--</el-descriptions-item>
                <el-descriptions-item label="應還時間">2025-03-08
                    12:00:00</el-descriptions-item>
            </el-descriptions>
        </el-tab-pane>
        <el-tab-pane label="用戶資料">
            <el-descriptions class="margin-top" title="註冊信息" :column="3" border>
                <el-descriptions-item label="註冊手機號">18002388777</el-descriptions-item>
                <el-descriptions-item label="註冊時間">2025年3月18日
                    11:00:00</el-descriptions-item>
                <el-descriptions-item label="註冊客戶端">H5</el-descriptions-item>
                <el-descriptions-item label="註冊渠道">湖人-木木分期</el-descriptions-item>
                <el-descriptions-item label="註冊經緯度">31.123456,121.123456</el-descriptions-item>
                <el-descriptions-item label="借款經緯度">31.123456,121.123456</el-descriptions-item>
                <el-descriptions-item label="居住地">四川省成都市邛崍市文君街道英倫半島</el-descriptions-item>
                <el-descriptions-item label="註冊所在地">四川省成都市邛崍市文君街道英倫半島</el-descriptions-item>
                <el-descriptions-item label="借款所在地">四川省成都市邛崍市文君街道英倫半島</el-descriptions-item>
            </el-descriptions>

            <el-descriptions class="margin-top" title="實名信息" :column="3" border>
                <el-descriptions-item label="真實姓名">劉鑫</el-descriptions-item>
                <el-descriptions-item label="身分證號">232327198005697598</el-descriptions-item>
                <el-descriptions-item label="性別">男</el-descriptions-item>
                <el-descriptions-item label="年齡">45</el-descriptions-item>
                <el-descriptions-item label="身分證頭像面">
                    <el-image style="width: 158px; height: 100px" :src="idcards[0]" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" show-progress :initial-index="4" :preview-src-list="idcards" fit="cover" />
                </el-descriptions-item>
                <el-descriptions-item label="身分證國徽面">
                    <el-image style="width: 158px; height: 100px" :src="idcards[1]" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" show-progress :initial-index="4" :preview-src-list="idcards" fit="cover" />
                </el-descriptions-item>
                <el-descriptions-item label="活體檢測照片">
                    <el-image style="width: 158px; height: 100px" :src="idcards[2]" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" show-progress :initial-index="4" :preview-src-list="idcards" fit="cover" />
                </el-descriptions-item>
                <el-descriptions-item label="運營商來源">未授權</el-descriptions-item>
                <el-descriptions-item label="客戶來源">http://eeee.one</el-descriptions-item>

            </el-descriptions>

            <el-descriptions class="margin-top" title="銀行卡信息" :column="3" border>
                <el-descriptions-item label="開戶銀行">中國工商銀行</el-descriptions-item>
                <el-descriptions-item label="銀行卡號">6230943690000330652</el-descriptions-item>
                <el-descriptions-item label="銀行預留手機號">18002388777</el-descriptions-item>

            </el-descriptions>

            <el-descriptions class="margin-top" title="單位信息" :column="3" border>
                <el-descriptions-item label="單位名稱">四川省高級人民法院</el-descriptions-item>
                <el-descriptions-item label="單位電話">028-12345678</el-descriptions-item>
                <el-descriptions-item label="單位地址">四川省成都市武侯區辛康路56號</el-descriptions-item>

            </el-descriptions>

            <el-descriptions class="margin-top" title="緊急聯繫人" :column="3" border>
                <el-descriptions-item label="關係">朋友</el-descriptions-item>
                <el-descriptions-item label="姓名">蔡徐坤</el-descriptions-item>
                <el-descriptions-item label="電話">18002388777</el-descriptions-item>
                <el-descriptions-item label="關係">家人</el-descriptions-item>
                <el-descriptions-item label="姓名">張學友</el-descriptions-item>
                <el-descriptions-item label="電話">18002388777</el-descriptions-item>
                <el-descriptions-item label="關係">同事</el-descriptions-item>
                <el-descriptions-item label="姓名">梁靜茹</el-descriptions-item>
                <el-descriptions-item label="電話">18002388777</el-descriptions-item>
        ...
        <el-tab-pane label="短信紀錄">
            <el-table :data="smsData" align="center" stripe>
                ...
                <el-table-column prop="type" label="類型"><template #default="{ row }">
        ...
        <el-tab-pane label="設備信息">
            <el-descriptions class="margin-top" title="系統信息" :column="4" border>
                ...
                <el-descriptions-item label="型號">Xiaomi
                    8A</el-descriptions-item>
                <el-descriptions-item label="定位地址">中國</el-descriptions-item>
            </el-descriptions>
            <div>
                <divstyle="font-size:16px;font-weight:bold;color:var(--ep-text-color-primary);margin-bottom:16px;margin-top:20px;">軟件列表
            </div>
            </div>
